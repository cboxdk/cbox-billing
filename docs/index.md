...
- **Repository:** `cboxdk/cbox-billing` — Laravel 13, PHP 8.4+, [MIT](https://github.com/cboxdk/cbox-billing/blob/main/LICENSE).
...
| **Open core** | The base app is MIT and complete on its own — use it, self-host it, or run it as a service, with no restriction. The commercial plugins are separately licensed and compose onto it purely through Laravel auto-discovery + a console-kit socket — zero edits to the app. |
