        ...
        <table class="tbl">
            ...
            <tbody>
                @forelse ($p['plans'] as $plan)
                    <tr data-href="{{ route('billing.plans.show', $plan['id']) }}">
                        <td><a class="cbx-row-link" href="{{ route('billing.plans.show', $plan['id']) }}"><span style="display:block;font-weight:500">{{ $plan['name'] }}</span><span class="num mut" style="font-size:11px">{{ $plan['key'] }}</span></a></td>
